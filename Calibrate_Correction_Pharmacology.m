function [coeffVals,theEqn,goodness,stats]=Calibrate_Correction_Pharmacology(filename)
close all
directory=cd;
...
LowPassData=filtfilt(sos_final,g_final,RawData);
LowPassData=LowPassData(((2*60*ChunkData.Params.DataFs):end),:);
...
savefig([ChunkData.Params.animalname '_' ChunkData.Params.date '_NormalizedHistogramFitPharmacology']);
